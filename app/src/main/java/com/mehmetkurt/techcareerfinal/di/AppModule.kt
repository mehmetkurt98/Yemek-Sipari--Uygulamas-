package com.mehmetkurt.techcareerfinal.di

import com.mehmetkurt.techcareerfinal.BuildConfig
import com.mehmetkurt.techcareerfinal.service.FoodAPI
import com.mehmetkurt.techcareerfinal.util.Util.BASE_URL
...
object AppModule {
    ...
    @Singleton
    @Provides
    fun provideApiFactory(retrofit: Retrofit): FoodAPI {
